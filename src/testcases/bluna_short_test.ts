...
async function main() {
    ...
    await mustPass(testState.basset.transfer_cw20_token(
        blunaContractAddress, testState.wallets.a, testState.wallets.b, 10000000))

    await mustFail(testState.basset.burn_cw20_token(blunaContractAddress, testState.wallets.b, 11000000))
    await mustPass(testState.basset.burn_cw20_token(blunaContractAddress, testState.wallets.b, 10000000))
    ...
    // TransferFrom
    await mustPass(testState.basset.increase_allowance(blunaContractAddress, testState.wallets.a, testState.wallets.b.key.accAddress, 100000, {never: {}}))
    await mustPass(testState.basset.transfer_from_cw20_token(blunaContractAddress, testState.wallets.b, testState.wallets.a, testState.wallets.b, 10000))
    await mustPass(testState.basset.transfer_from_cw20_token(blunaContractAddress, testState.wallets.b, testState.wallets.a, testState.wallets.b, 20000))
    await mustPass(testState.basset.decrease_allowance(blunaContractAddress, testState.wallets.a, testState.wallets.b.key.accAddress, 100000, {never: {}}))
    ...
    // BurnFrom
    await mustPass(testState.basset.increase_allowance(blunaContractAddress, testState.wallets.a, testState.wallets.b.key.accAddress, 100000, {never: {}}))
    await mustPass(testState.basset.burn_from_cw20_token(blunaContractAddress, testState.wallets.b, testState.wallets.a, 10000))
    await mustPass(testState.basset.decrease_allowance(blunaContractAddress, testState.wallets.a, testState.wallets.b.key.accAddress, 100000, {never: {}}))
    await mustFail(testState.basset.burn_from_cw20_token(blunaContractAddress, testState.wallets.b, testState.wallets.a, 10000))

    // SendFrom
    await mustPass(testState.basset.increase_allowance(blunaContractAddress, testState.wallets.a, testState.wallets.b.key.accAddress, 1000000, {never: {}}))
