...
async function main() {
    ...
    fs.writeFileSync("14_block149_state.json", JSON.stringify(await mantleState.getState(), null, 2))
...
main()
    ...
    .then(async () => {
        console.log("saving state...")
        fs.writeFileSync("14_actions.json", JSON.stringify(getRecord(), null, 2))
        fs.writeFileSync("14_state.json", JSON.stringify(await mantleState.getState(), null, 2))
    })
    .catch(console.log)