...
export default class AnchorbAsset {
    ...
    public async instantiate_airdrop(sender: Wallet, params:{
        hub_contract?:string,
        reward_contract?:string
    }, fee?: StdFee){
        const init = await instantiate(sender, this.contractInfo.anchor_airdrop_registry.codeId,
            {
    ...
    public async register_contracts(sender: Wallet, params: {
        ...
        const msg = await execute(
            ...
            this.contractInfo["anchor_basset_hub"].contractAddress,
            {
                update_config: {
                    owner:undefined,
                    reward_contract: params.reward_address ||`${this.contractInfo["anchor_basset_reward"].contractAddress}`,
                    token_contract: params.token_address ||`${this.contractInfo["anchor_basset_token"].contractAddress}`,
                    airdrop_registry_contract: params.airdrop_registry_contract || `${this.contractInfo["anchor_airdrop_registry"].contractAddress}`,
                },
            },
            undefined,
            fee,
