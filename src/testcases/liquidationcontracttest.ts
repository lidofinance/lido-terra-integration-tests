...
main()
    ...
    .then(async () => {
        ...
        fs.writeFileSync("liquidationcontract_actions.json", JSON.stringify(getRecord(), null, 2))
        fs.writeFileSync("liquidationcontract_state.json", JSON.stringify(await mantleState.getState(), null, 2))
    })
    .catch(console.log)