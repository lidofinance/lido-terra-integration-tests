...
main()
    ...
    .then(async () => {
        ...
        fs.writeFileSync("msgtestactions.json", JSON.stringify(getRecord(), null, 2))
        fs.writeFileSync("msgtestmantleState.json", JSON.stringify(await mantleState.getState(), null, 2))
    })
    .catch(console.log)