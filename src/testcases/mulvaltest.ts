...
main()
    ...
    .then(async () => {
        ...
        fs.writeFileSync("mulval_afterfix_actions.json", JSON.stringify(getRecord(), null, 2))
        fs.writeFileSync("mulval_afterfix_state.json", JSON.stringify(await mantleState.getState(), null, 2))
    })
    .catch(console.log)