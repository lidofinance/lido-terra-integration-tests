...
async function main() {
    ...
    fs.writeFileSync("3_block149_state.json", JSON.stringify(await mantleState.getState(), null, 2))
...
main()
    ...
    .then(async () => {
        console.log("saving state...")
        fs.writeFileSync("3_actions.json", JSON.stringify(getRecord(), null, 2))
