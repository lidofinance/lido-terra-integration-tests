...
async function main() {
    ...
    fs.writeFileSync("corner_30_state.json", JSON.stringify(await mantleState.getState(), null, 2))
    ...
    console.log("saving state...")
    fs.writeFileSync("corner_33_state.json", JSON.stringify(await mantleState.getState(), null, 2))
...
main()
    ...
    .then(async () => {
        console.log("saving state...")
        fs.writeFileSync("corner_actions.json", JSON.stringify(getRecord(), null, 2))
        fs.writeFileSync("corner_state.json", JSON.stringify(await mantleState.getState(), null, 2))
    })
    .catch(console.log)