...
async function main() {
    ...
    fs.writeFileSync("10_block149_state.json", JSON.stringify(await mantleState.getState(), null, 2))
...
main()
    ...
    .then(async () => {
        console.log("saving state...")
        fs.writeFileSync("10_actions.json", JSON.stringify(getRecord(), null, 2))
        fs.writeFileSync("10_state.json", JSON.stringify(await mantleState.getState(), null, 2))
    })
    .catch(console.log)