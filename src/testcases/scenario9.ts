...
async function main() {
    ...
    //block 120
    await mustFail(basset.finish(a))
...
main()
    ...
    .then(async () => {
        console.log("saving state...")
        fs.writeFileSync("9_actions.json", JSON.stringify(getRecord(), null, 2))
        fs.writeFileSync("9_state.json", JSON.stringify(await mantleState.getState(), null, 2))
    })
    .catch(console.log)