...
async function main() {
    ...
    await anchor.instantiate(fixedFeeForInit, {
        basset: {
            ...
            er_threshold: "1.0",
            reward_denom: "uusd",
            validator: validators[0].validator_address
        }
    });
    ...
    fs.writeFileSync("beforedepositcollateral_state.json", JSON.stringify(await mantleState.getState(), null, 2))
    ...
    fs.writeFileSync("depositcollateral_state.json", JSON.stringify(await mantleState.getState(), null, 2))
}
