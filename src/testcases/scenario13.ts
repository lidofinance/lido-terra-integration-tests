...
async function main() {
    ...
    fs.writeFileSync("13_block149_state.json", JSON.stringify(await mantleState.getState(), null, 2))
...
main()
    ...
    .then(async () => {
        console.log("saving state...")
        fs.writeFileSync("13_actions.json", JSON.stringify(getRecord(), null, 2))
        fs.writeFileSync("13_state.json", JSON.stringify(await mantleState.getState(), null, 2))
    })
    .catch(console.log)