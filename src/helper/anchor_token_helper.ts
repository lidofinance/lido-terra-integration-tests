  ...
  public async gov_instantiate(
    ...
    const init = await instantiate(
      ...
      contract,
      {
        ...
        voting_period: params.voting_period || 10,
        timelock_period: params.timelock_period || 10,
        expiration_period: params.expiration_period || 10,
        proposal_deposit: params.proposal_deposit || "1000000",
        snapshot_period: params.snapshot_period || 5,
      },
      undefined,
      fee
    );
